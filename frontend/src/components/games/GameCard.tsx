...
export const GameCard = ({
  ...
  return (
    <div
      className={cn(
        "relative group flex flex-col bg-card rounded-[2rem] border-2 border-border",
    ...
    >
      ...
      <div className="px-4 pb-4 flex flex-col items-center">
        <h3 className="text-lg font-black text-foreground tracking-tight uppercase italic text-center drop-shadow-sm">
          {title}
        </h3>
      </div>
    </div>
